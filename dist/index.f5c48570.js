...
function op() {
    ...
    switch(calcStore.op){
        ...
        case '-':
            ...
            for(let i = 1; i < calcStore.working.length; i++)sum = sum - calcStore.working[i];
            calcStore.working = [];
            calcStore.default = sum;
            calcStore.working.push(sum);
            break;
        case '/':
            sum = calcStore.working[0];
            for(let i1 = 1; i1 < calcStore.working.length; i1++){
                console.log(sum, calcStore.working[i1]);
                sum = sum / calcStore.working[i1];
            }
            calcStore.working = [];
            calcStore.default = sum;
            calcStore.working.push(sum);
        ...
        case 'X':
            sum = calcStore.working[0];
            for(let i2 = 1; i2 < calcStore.working.length; i2++)sum = sum * calcStore.working[i2];
            calcStore.working = [];
            calcStore.default = sum;
            calcStore.working.push(sum);
            break;
...
},{}]},["iwoPf","8ZNvh"], "8ZNvh", "parcelRequireff1f")
